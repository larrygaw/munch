...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    backgroundColor: '#1A1A1A', // A softer white for a modern, minimalist background
  },
  title: {
    fontSize: 40, // A bit larger for a more striking appearance
    fontWeight: '800', // Extra bold for emphasis
    marginBottom: 40, // Increased space for a more airy, open feel
    color: 'orange', // A deep indigo for a sophisticated, modern look
  },
  textInput: {
  ...
  buttonLogin: {
    width: '40%',
    marginVertical: 10,
    backgroundColor: 'orange', // A lighter indigo to complement the title color
    padding: 10,
  ...
  buttonSignUp: {
    width: '40%',
    marginVertical: 10,
    backgroundColor: 'white', // A lighter indigo to complement the title color
    padding: 10,
    borderRadius: 15, // Matching rounded corners for consistency
    alignItems: 'center',
    justifyContent: 'center',
  ...
  textSignUp: {
    color: 'black', // Maintained white for clear visibility
    fontSize: 18, // Slightly larger for emphasis
    fontWeight: '600', // Semi-bold for a balanced weight
  },
  ...
  buttonRow: {
    ...
    gap: 10, // optional, for spacing if supported
  },
})